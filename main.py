...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label=tk.Label(self,text="Number of equations = ")
        ...
        tk.Radiobutton(self,
                       ...
                       value=6, width=1, command=self.print_path, fg='blue', bg='white').grid(row=0, column=200)
        SubmitButton = tk.Button(self, text='Done', fg='white', bg='blue',
                                 command=lambda: self.OnSubmit(), height=1, width=50)
    ...
    def OnSubmit(self):
     ...
     for numbers in range(self.NumberOfEquations):
             ...
             self.namR[numbers].grid(row=2 + numbers, column=1)

     tk.Label(self,
              text="""The method""",
              justify=tk.LEFT,
              padx=18, fg='white', bg='blue').grid(row=10, column=4)

     tk.Radiobutton(self,
                    text="gauss elimination",
                    padx=20,
                    variable=self.v,
                    value=1, width=12, bg='white').grid(row=11, column=4)

     tk.Radiobutton(self,
                    text="gauss jordan",
                    padx=20,
                    variable=self.v,
                    value=2, width=12, bg='white').grid(row=12, column=4)
     tk.Radiobutton(self,
                    text="LU decomposition",
                    padx=20,
                    variable=self.v,
                    value=3, width=12, bg='white').grid(row=13, column=4)

     tk.Radiobutton(self,
                    text="Gauss seidle",
                    padx=20,
                    variable=self.v,
                    value=4, width=12, bg='white').grid(row=14, column=4)

     tk.Radiobutton(self,
                    text="All",
                    padx=20,
                    variable=self.v,
                    value=5, width=12, bg='white').grid(row=15, column=4)
    #  lb = tk.Label(self, text="Incase of gauss seidel:", fg='white', bg='blue').grid(column=4, row=16, pady=10)
     lbl = tk.Label(self, text=" Enter Tolerence", fg='white', bg='blue').grid(column=4, row=17, pady=10)
     lb2 = tk.Label(self, text="Number of iterations", fg='white', bg='blue').grid(column=4, row=19)
     self.expression_field_1 = tk.Entry(self, width=9)
     self.expression_field_1.grid(row=18, column=4, pady=10)
     self.expression_field_2 = tk.Entry(self, width=9)
     self.expression_field_2.grid(row=20, column=4)
     l = tk.Label(self, text="Intial guesses:", fg='white', bg='blue').grid(column=1, row=19, pady=10)
     self.guess = []
     for numbers in range(self.NumberOfEquations):
         self.guess.append(tk.Entry(self))
         self.guess[numbers].grid(row=23 + numbers, column=1)

     ShowButton = tk.Button(self, text='Done', fg='white', bg='blue',
                              command=lambda: self.collect(), height=1, width=9)
     ShowButton.grid(row=24+self.NumberOfEquations, column=1)
